...
is $multi1->{1}, 0, 'get bitstring MULTI (1)'; #16
is $multi1->{2}, 0, 'get bitstring MULTI (2)'; #17
is $multi1->{3}, 0, 'get bitstring MULTI (3)'; #18
my $multi2 = $recs[1]->{test4}->values_by_id;
is $multi2->{1}, 0, 'get bitstring MULTI (4)'; #19
is $multi2->{2}, 1, 'get bitstring MULTI (5)'; #20
is $multi2->{3}, 0, 'get bitstring MULTI (6)'; #21
my $multi3 = $recs[2]->{test4}->values;
is scalar(@{$multi3}), 2,   'ordered bitstring MULTI count'; #22
is $multi3->[0]->value, 2, 'get ordered bitstring MULTI (1)'; #23
is $multi3->[1]->label, 'Three', 'get ordered bitstring MULTI (2)'; #24

## Now, let's get some MULTIPLE records in SPREAD format.
my $multi4 = $recs[0]->{test5}->values_by_id;
is $multi4->{1}, 1, 'get SPREAD MULTI (1)'; #25
is $multi4->{5}, 1, 'get SPREAD MULTI (2)'; #26
is $multi4->{15}, 0, 'get SPREAD MULTI (3)'; #27
is $multi4->{26}, 0, 'get SPREAD MULTI (4)'; #28
...
is $multi6->{1}, 0, 'get implicit SPREAD MULTI (1)'; #31
is $multi6->{2}, 1, 'get implicit SPREAD MULTI (2)'; #32
my $multi7 = $recs[1]->{test6}->values;
is $multi7->[0]->label, 'One', 'get ordered implicit SPREAD MULTI (1)'; #33
is $multi7->[1]->value, 3, 'get ordered implicit SPREAD MULTI (2)'; #34
